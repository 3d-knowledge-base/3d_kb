...
$$
\mathcal{L}_{VAE} = \mathcal{L}_{geo} + \lambda_{KL}\mathcal{L}_{KL}
$$
...
$$
\mathcal{L}_{geo} = \lambda_{sdf}\mathcal{L}_{sdf} + \lambda_{def}\mathcal{L}_{def} + \lambda_{occ}\mathcal{L}_{occ} + \lambda_{cd}\mathcal{L}_{cd}
$$
...
$$
\mathcal{L}_{diff} = \mathbb{E}_{t,\epsilon}\left[\|\epsilon - \epsilon_\theta(\mathbf{z}_t, t, c)\|^2\right]
$$
